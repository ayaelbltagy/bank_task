...
class MainRepository @Inject constructor(private val apiHelper: ApiHelper) {
    ...
    suspend fun getHistory(date: String, from: String, to: String): Response<HistoryResponse> =
        apiHelper.getHistory(date, from, to)

    suspend fun convert(from: String, to: String, amountValue: String): Response<ConvertResponse> =
        apiHelper.convert(from, to, amountValue)
}